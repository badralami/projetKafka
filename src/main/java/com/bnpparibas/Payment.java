...
public class Payment extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 6753767279247954917L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Payment\",\"namespace\":\"com.bnpparibas\",\"fields\":[{\"name\":\"first_name\",\"type\":\"string\",\"doc\":\"First Name of Customer\"},{\"name\":\"last_name\",\"type\":\"string\",\"doc\":\"Last Name of Customer\"},{\"name\":\"age\",\"type\":\"int\",\"doc\":\"Age at the time of registration\"}],\"version\":\"1\"}");
   ...
   */
  public static com.bnpparibas.Payment.Builder newBuilder() {
    return new com.bnpparibas.Payment.Builder();
  }
   ...
   * @return A new Payment RecordBuilder
   */
  public static com.bnpparibas.Payment.Builder newBuilder(com.bnpparibas.Payment.Builder other) {
    return new com.bnpparibas.Payment.Builder(other);
  }
   ...
   * @return A new Payment RecordBuilder
   */
  public static com.bnpparibas.Payment.Builder newBuilder(com.bnpparibas.Payment other) {
    return new com.bnpparibas.Payment.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Payment>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.bnpparibas.Payment.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.bnpparibas.Payment other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.first_name)) {
        this.first_name = data().deepCopy(fields()[0].schema(), other.first_name);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bnpparibas.Payment.Builder setFirstName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bnpparibas.Payment.Builder clearFirstName() {
      first_name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bnpparibas.Payment.Builder setLastName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bnpparibas.Payment.Builder clearLastName() {
      last_name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bnpparibas.Payment.Builder setAge(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bnpparibas.Payment.Builder clearAge() {
